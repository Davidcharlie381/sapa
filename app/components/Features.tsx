...
export default function Features() {
    return (
        <div  className="max-w-[94%] mx-auto pt-14 md:pt-20 text-[#001B1F]">
            ...
            <section className="grid sm:grid-cols-2 md:grid-cols-3 mt-10 gap-7">
                <div className="bg-white rounded-[20px] w-[330px] mx-auto max-w-[360px] p-[25px]">
